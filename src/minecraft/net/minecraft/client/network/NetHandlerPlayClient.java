...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleSpawnObject(SPacketSpawnObject packetIn)
    {
        ...
        {
            entity = new EntityFireworkRocket(this.clientWorldController, d0, d1, d2, ItemStack.EMPTY_ITEM_STACK);
        }
        ...
        {
            entity = new EntityPotion(this.clientWorldController, d0, d1, d2, ItemStack.EMPTY_ITEM_STACK);
            packetIn.setData(0);
        }
    ...
    public void handleCollectItem(SPacketCollectItem packetIn)
    {
        ...
        if (entity != null)
        {
            ...
            {
                ((EntityItem)entity).getEntityItem().setStackSize(packetIn.func_191208_c());
            }
        ...
        else
        {
            ...
            if (packetIn.getWindowId() == 0 && packetIn.getSlot() >= 36 && i < 45)
            {
                if (!itemstack.isNotValid())
                {
                    ...
                    if (itemstack1.isNotValid() || itemstack1.getStackSize() < itemstack.getStackSize())
                    {
