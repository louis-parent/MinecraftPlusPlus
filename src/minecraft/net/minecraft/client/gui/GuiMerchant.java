...
public class GuiMerchant extends GuiContainer
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (merchantrecipelist != null && !merchantrecipelist.isEmpty())
        {
            ...
            if (this.isPointInRegion(36, 24, 16, 16, mouseX, mouseY) && !itemstack.isNotValid())
            {
                this.renderToolTip(itemstack, mouseX, mouseY);
            }
            else if (!itemstack1.isNotValid() && this.isPointInRegion(62, 24, 16, 16, mouseX, mouseY) && !itemstack1.isNotValid())
            {
                this.renderToolTip(itemstack1, mouseX, mouseY);
            }
            else if (!itemstack2.isNotValid() && this.isPointInRegion(120, 24, 16, 16, mouseX, mouseY) && !itemstack2.isNotValid())
            {
