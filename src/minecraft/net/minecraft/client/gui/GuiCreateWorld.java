...
public class GuiCreateWorld extends GuiScreen
{
	...
	/**
	 * Used to save away the game mode when the current "debug" world type is
	 * chosen (forcing it to spectator mode)
	 */
	...
	/**
	 * User explicitly clicked "Allow Cheats" at some point Prevents value
	 * changes due to changing game mode
	 */
	...
	/**
	 * Ensures that a proposed directory name doesn't collide with existing
	 * names. Returns the name, possibly modified to avoid collisions.
	 */
	...
	/**
	 * Returns whether the currently-selected world type is actually acceptable
	 * for selection Used to hide the "debug" world type unless the shift key is
	 * depressed.
	 */
	...
	/**
	 * Toggles between initial world-creation display, and "more options"
	 * display. Called when user clicks "More World Options..." or "Done" (same
	 * button, different labels depending on current display).
	 */
	...
	/**
	 * Shows additional world-creation options if toggle is true, otherwise
	 * shows main world-creation elements
	 */
