...
public class GuiIngame extends Gui
{
    ...
    private ItemStack highlightingItemStack = ItemStack.EMPTY_ITEM_STACK;
    ...
    public void renderSelectedItem(ScaledResolution scaledRes)
    {
        ...
        if (this.remainingHighlightTicks > 0 && !this.highlightingItemStack.isNotValid())
        {
    ...
    private void renderHotbarItem(int p_184044_1_, int p_184044_2_, float p_184044_3_, EntityPlayer player, ItemStack stack)
    {
        if (!stack.isNotValid())
        {
            float f = (float)stack.getAnimationToGo() - p_184044_3_;
    ...
    public void updateTick()
    {
        ...
        if (this.mc.player != null)
        {
            ...
            else if (!this.highlightingItemStack.isNotValid() && itemstack.getItem() == this.highlightingItemStack.getItem() && ItemStack.areItemStackTagsEqual(itemstack, this.highlightingItemStack) && (itemstack.isItemStackDamageable() || itemstack.getMetadata() == this.highlightingItemStack.getMetadata()))
            {
