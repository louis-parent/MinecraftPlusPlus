...
public class Minecraft implements IThreadListener, ISnooperInfo
{
		...
		if (!this.playerController.getIsHittingBlock())
		{
			...
			if (!this.player.isRowingBoat())
			{
				...
				for (EnumHand enumhand : EnumHand.values())
				{
							...
							case BLOCK:
								...
								if (this.world.getBlockState(blockpos).getMaterial() != Material.AIR)
								{
									...
									if (enumactionresult == EnumActionResult.SUCCESS)
									{
										...
										if (!itemstack.isNotValid() && (itemstack.getStackSize() != i || this.playerController.isInCreativeMode()))
										{
					...
					if (!itemstack.isNotValid() && this.playerController.processRightClick(this.player, this.world, enumhand) == EnumActionResult.SUCCESS)
					{
						this.entityRenderer.itemRenderer.resetEquippedProgress(enumhand);
						return;
					}
	...
	public void launchIntegratedServer(String folderName, String worldName, @Nullable WorldSettings worldSettingsIn)
	{
		...
		System.out.println(worldSettingsIn.getSeed());
		ModBootstrap.redo(this, worldSettingsIn.getSeed());
