...
public class RecipeItemHelper
{
    ...
    {
        if (!p_194112_1_.isNotValid() && !p_194112_1_.isItemDamaged() && !p_194112_1_.isItemEnchanted() && !p_194112_1_.hasDisplayName())
        {
            int i = func_194113_b(p_194112_1_);
            int j = p_194112_1_.getStackSize();
    ...
    {
        return p_194115_0_ == 0 ? ItemStack.EMPTY_ITEM_STACK : new ItemStack(Item.getItemById(p_194115_0_ >> 16 & 65535), 1, p_194115_0_ & 65535);
    }
