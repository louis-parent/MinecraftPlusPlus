...
public class BufferBuilder
{
	 ...
	 * 
	 * @param vertexIndex
	 *            The index of the vertex in question, where 0 is the last one
	 ...
	 * 
	 * @param vertexIndex
	 *            The index of the vertex to modify, where 0 is the last one
	 *            added, 1 is the second last, etc.
	 */
	 ...
	 * 
	 * @param index
	 *            The index in the vertex data buffer to which the color data
	 *            will be written, in {@code int}s
	 */
