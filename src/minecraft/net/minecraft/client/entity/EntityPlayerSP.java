...
public class EntityPlayerSP extends AbstractClientPlayer
{
	...
	{
		this.inventory.setItemStack(ItemStack.EMPTY_ITEM_STACK);
		super.closeScreen();
	...
	/**
	 * Sets the brand of the currently connected server. Server brand
	 * information is sent over the {@code MC|Brand} plugin channel, and is used
	 * to identify modded servers in crash reports.
	 */
	...
	/**
	 * Gets the brand of the currently connected server. May be null if the
	 * server hasn't yet sent brand information. Server brand information is
	 * sent over the {@code MC|Brand} plugin channel, and is used to identify
	 * modded servers in crash reports.
	 */
