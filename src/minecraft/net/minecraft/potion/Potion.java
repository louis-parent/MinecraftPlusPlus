...
public class Potion
{
	...
	/**
	 * Get if the potion is beneficial to the player. Beneficial potions are
	 * shown on the first row of the HUD
	 */
	...
	/**
	 * Set that the potion is beneficial to the player. Beneficial potions are
	 * shown on the first row of the HUD
	 */
