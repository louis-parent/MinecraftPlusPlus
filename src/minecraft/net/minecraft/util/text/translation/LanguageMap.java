...
public class LanguageMap
{
	...
	private static void modLanguageMap(LanguageMap map)
	{
		for (Entry<String, String> entry : ModLanguage.getTranslation().entrySet())
		{
			map.languageList.put(entry.getKey(), entry.getValue());
			String t = map.languageList.get(entry.getKey());
			t.toCharArray();
		}
	}
