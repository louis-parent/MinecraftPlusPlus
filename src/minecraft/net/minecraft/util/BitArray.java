...
public class BitArray
{
	 ...
	 * single entry. For instance, if bitsPerEntry were 5, this value would be
	 * 31 (ie, {@code 0b00011111}).
	 */
	private final long maxEntryValue;

	/**
	 * Number of entries in this array (<b>not</b> the length of the long array
	 * that internally backs this array)
	 */
	...
	/**
	 * Gets the long array that is used to store the data in this BitArray. This
	 * is useful for sending packet data.
	 */
