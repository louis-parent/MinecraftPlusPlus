			...
			if (combatentry != null && combatentry1.getDamageSrc() == DamageSource.fall)
			{
				...
				if (combatentry.getDamageSrc() != DamageSource.fall && combatentry.getDamageSrc() != DamageSource.outOfWorld)
				{
					if (itextcomponent2 != null && (itextcomponent1 == null || !itextcomponent2.equals(itextcomponent1)))
					{
						...
						ItemStack itemstack1 = entity1 instanceof EntityLivingBase ? ((EntityLivingBase) entity1).getHeldItemMainhand() : ItemStack.EMPTY_ITEM_STACK;

						if (!itemstack1.isNotValid() && itemstack1.hasDisplayName())
						{
					...
					{
						ItemStack itemstack = entity instanceof EntityLivingBase ? ((EntityLivingBase) entity).getHeldItemMainhand() : ItemStack.EMPTY_ITEM_STACK;

						if (!itemstack.isNotValid() && itemstack.hasDisplayName())
						{
