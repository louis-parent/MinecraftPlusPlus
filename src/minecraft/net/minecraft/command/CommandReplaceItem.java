	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
	{
		...
		else
		{
			...
			else
			{
				...
				{
					throw new CommandException("commands.replaceitem.failed", new Object[] { s, k, itemstack.isNotValid() ? "Air" : itemstack.getTextComponent() });
				}
			...
			notifyCommandListener(sender, this, "commands.replaceitem.success", new Object[] { s, k, itemstack.isNotValid() ? "Air" : itemstack.getTextComponent() });
		}
	}
