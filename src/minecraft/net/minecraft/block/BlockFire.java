...
public class BlockFire extends Block
{
	...
	/**
	 * Searches for every static attribute of the Class blockList and tests for
	 * flammability if the attribute is an instance of the class or subclass of
	 * Block If the Block is flammable then adds the fire info
	 * 
	 * @param blockList
	 *            : the Class to search all the fields
	 */
	@Mod("Minecraftpp")
