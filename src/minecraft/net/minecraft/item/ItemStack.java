...
public final class ItemStack
{
	...
	/**
	 * Calls the delegated method to the Item to damage the incoming Entity, and
	 * if necessary, triggers a stats increase.
	 */
	...
	public ItemStack copy()
	{
		...
		itemstack.setAnimationToGo(this.getAnimationToGo());
	...
	{
		if (stackA.isNotValid() && stackB.isNotValid())
		{
			return true;
		}
		else if (!stackA.isNotValid() && !stackB.isNotValid())
		{
	...
	public static boolean areItemStacksEqual(ItemStack stackA, ItemStack stackB)
	{
		...
		{
			return !stackA.isNotValid() && !stackB.isNotValid() ? stackA.isItemStackEqual(stackB) : false;
		}
	}
	...
	public static boolean areItemsEqual(ItemStack stackA, ItemStack stackB)
	{
		...
		{
			return !stackA.isNotValid() && !stackB.isNotValid() ? stackA.isItemEqual(stackB) : false;
		}
	}
	...
	public static boolean areItemsEqualIgnoreDurability(ItemStack stackA, ItemStack stackB)
	{
		...
		{
			return !stackA.isNotValid() && !stackB.isNotValid() ? stackA.isItemEqualIgnoreDurability(stackB) : false;
		}
	}
	...
	{
		return !other.isNotValid() && this.item == other.item && this.itemDamage == other.itemDamage;
	}
	...
	public boolean isItemEqualIgnoreDurability(ItemStack stack)
	{
		...
		{
			return !stack.isNotValid() && this.item == stack.item;
		}
	}
	...
	{
		return !this.notValid && this.stackTagCompound != null;
	}
	...
	{
		return this.notValid ? null : this.itemFrame;
	}
	...
	public int getAnimationToGo()
	{
		return this.animationsToGo;
	}

	public void setAnimationToGo(int animationToGo)
	{
		this.animationsToGo = animationToGo;
	}

	public int getStackSize()
	{
		return this.notValid ? 0 : this.stackSize;
	}
	...
	{
		this.setStackSize(this.stackSize + amount);
	}

	public void decreaseStackSize(int amount)
	{
		this.increaseStackSize(-amount);
	}
}
