...
public abstract class World implements IBlockAccess
{
	...
	/**
	 * Returns, from the height map, the height of the highest block at this x
	 * and z coordinate.
	 */
	...
	/**
	 * Warning this value may not be respected in all cases as it is still
