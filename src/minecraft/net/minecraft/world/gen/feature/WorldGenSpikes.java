...
public class WorldGenSpikes extends WorldGenerator
{
	...
	/**
	 * Sets the value that will be used in a call to
	 * entitycrystal.setBeamTarget. At the moment, WorldGenSpikes.setBeamTarget
	 * is only ever called with a value of (0, 128, 0)
	 */
