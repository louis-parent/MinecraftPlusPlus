...
public class Village
{
	...
	/**
	 * Checks to see if the distance squared between this BlockPos and the
	 * center of this Village is less than this Village's villageRadius squared
	 */
	...
	/**
	 * Modify a players reputation in the village. Use positive values to
	 * increase reputation and negative values to decrease. <br>
