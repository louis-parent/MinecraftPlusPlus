...
public class MerchantRecipe
{
	...
	{
		this.itemToBuy = ItemStack.EMPTY_ITEM_STACK;
		this.secondItemToBuy = ItemStack.EMPTY_ITEM_STACK;
		this.itemToSell = ItemStack.EMPTY_ITEM_STACK;
	...
	{
		this(buy1, ItemStack.EMPTY_ITEM_STACK, sell);
	}
	...
	{
		return !this.secondItemToBuy.isNotValid();
	}
	...
	public NBTTagCompound writeToTags()
	{
		...
		if (!this.secondItemToBuy.isNotValid())
		{
