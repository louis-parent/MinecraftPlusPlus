		...
		else if (other.isEntityAlive() && this.isEntityAlive())
		{
			...
			if (this.delayBeforeCanPickup != 32767 && other.delayBeforeCanPickup != 32767)
			{
				if (this.age != -32768 && other.age != -32768)
				{
					...
					else if (itemstack1.getStackSize() < itemstack.getStackSize())
					{
						return other.combineItems(this);
					}
					else if (itemstack1.getStackSize() + itemstack.getStackSize() > itemstack1.getMaxStackSize())
					{
						return false;
					}
					else
					{
						itemstack1.increaseStackSize(itemstack.getStackSize());
