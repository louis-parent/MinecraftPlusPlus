...
public abstract class Entity implements ICommandSender
{
	...
	/**
	 * A horizontal vector related to the position of the last portal the entity
	 * was in
	 */
	 ...
	 * This applies to container minecarts.
	 */
	...
	/**
	 * Attempts to write this Entity to the given NBTTagCompound. Returns false
	 * if the entity is dead or its string representation is null. In this
	 * event, the given NBTTagCompound is not modified.
	 * 
	 * Similar to writeToNBTOptional, but does not check whether this Entity is
	 * a passenger of another.
	 */
	...
	/**
	 * Marks the entity as being inside a portal, activating teleportation logic
	 * in onEntityUpdate() in the following tick(s).
	 */
	 ...
	 * it. This does not have a side-effect.
	 */
