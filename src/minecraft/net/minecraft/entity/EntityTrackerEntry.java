...
public class EntityTrackerEntry
{
	...
	public void updatePlayerList(List<EntityPlayer> players)
	{
		...
		if (this.trackedEntity instanceof EntityItemFrame && this.updateCounter % 10 == 0)
		{
			...
			{
				MapData mapdata = ((ItemMap) Items.getItem(Items.FILLED_MAP)).getMapData(itemstack, this.trackedEntity.world);

				for (EntityPlayer entityplayer : players)
				{
					EntityPlayerMP entityplayermp = (EntityPlayerMP) entityplayer;
					mapdata.updateVisiblePlayers(entityplayermp, itemstack);
					Packet<?> packet = ((ItemMap) Items.getItem(Items.FILLED_MAP)).createMapDataPacket(itemstack, this.trackedEntity.world, entityplayermp);
