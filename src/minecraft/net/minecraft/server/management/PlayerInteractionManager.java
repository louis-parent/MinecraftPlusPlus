...
public class PlayerInteractionManager
{
    ...
    {
        if (this.gameType.isCreative() && !this.thisPlayerMP.getHeldItemMainhand().isNotValid() && this.thisPlayerMP.getHeldItemMainhand().getItem() instanceof ItemSword)
        {
            return false;
        }
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    ItemStack itemstack2 = itemstack1.isNotValid() ? ItemStack.EMPTY_ITEM_STACK : itemstack1.copy();
    ...
    public EnumActionResult processRightClick(EntityPlayer player, World worldIn, ItemStack stack, EnumHand hand)
    {
        ...
        else
        {
            ...
            if (itemstack == stack && itemstack.getStackSize() == i && itemstack.getMaxItemUseDuration() <= 0 && itemstack.getMetadata() == j)
            {
            ...
            else
            {
                ...
                if (itemstack.isNotValid())
                {
                    player.setHeldItem(hand, ItemStack.EMPTY_ITEM_STACK);
                }
    ...
    public EnumActionResult processRightClickBlock(EntityPlayer player, World worldIn, ItemStack stack, EnumHand hand, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            if (!player.isSneaking() || player.getHeldItemMainhand().isNotValid() && player.getHeldItemOffhand().isNotValid())
            {
