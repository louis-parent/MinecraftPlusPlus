...
public class PlayerChunkMapEntry
{
	...
	/**
	 * Provide the chunk at the player's location. Can fail, returning false, if
	 * the player is a spectator floating outside of any pre-existing chunks,
	 * and the server is not configured to allow chunk generation for
	 * spectators.
	 */
	...
	/**
	 * Send packets to player for: - nearby tile entities - nearby entities that
	 * are leashed - nearby entities with
	 */
