...
public class NBTTagCompound extends NBTBase
{
	...
	/**
	 * Returns whether the given string has been previously stored as a key in
	 * this tag compound as a particular type, denoted by a parameter in the
	 * form of an ordinal. If the provided ordinal is 99, this method will match
	 * tag types representing numbers.
	 */
