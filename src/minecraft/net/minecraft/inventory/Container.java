...
public abstract class Container
{
    ...
    protected Slot addSlotToContainer(Slot slotIn)
    {
        ...
        this.inventoryItemStacks.add(ItemStack.EMPTY_ITEM_STACK);
        return slotIn;
    }
    ...
    public void detectAndSendChanges()
    {
        for (int i = 0; i < this.inventorySlots.size(); ++i)
        {
            ...
            {
                itemstack1 = itemstack.isNotValid() ? ItemStack.EMPTY_ITEM_STACK : itemstack.copy();
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        return slot != null ? slot.getStack() : ItemStack.EMPTY_ITEM_STACK;
    }
    ...
    public ItemStack slotClick(int slotId, int dragType, ClickType clickTypeIn, EntityPlayer player)
    {
        ...
        if (clickTypeIn == ClickType.QUICK_CRAFT)
        {
            ...
            else if (inventoryplayer.getItemStack().isNotValid())
            {
                this.resetDrag();
            }
            ...
            else if (this.dragEvent == 1)
            {
                ...
                if (slot7 != null && canAddItemToSlot(slot7, itemstack12, true) && slot7.isItemValid(itemstack12) && (this.dragMode == 2 || itemstack12.getStackSize() > this.dragSlots.size()) && this.canDragIntoSlot(slot7))
                {
            ...
            else if (this.dragEvent == 2)
            {
                if (!this.dragSlots.isEmpty())
                {
                    ...
                    int k1 = inventoryplayer.getItemStack().getStackSize();

                    for (Slot slot8 : this.dragSlots)
                    {
                        ItemStack itemstack13 = inventoryplayer.getItemStack();

                        if (slot8 != null && canAddItemToSlot(slot8, itemstack13, true) && slot8.isItemValid(itemstack13) && (this.dragMode == 2 || itemstack13.getStackSize() >= this.dragSlots.size()) && this.canDragIntoSlot(slot8))
                        {
                            ItemStack itemstack14 = itemstack9.copy();
                            int j3 = slot8.getHasStack() ? slot8.getStack().getStackSize() : 0;
                            ...
                            if (itemstack14.getStackSize() > k3)
                            {
                                itemstack14.setStackSize(k3);
                            }

                            k1 -= itemstack14.getStackSize() - j3;
                            slot8.putStack(itemstack14);
                        }
                    }

                    itemstack9.setStackSize(k1);
        ...
        else if ((clickTypeIn == ClickType.PICKUP || clickTypeIn == ClickType.QUICK_MOVE) && (dragType == 0 || dragType == 1))
        {
            if (slotId == -999)
            {
                if (!inventoryplayer.getItemStack().isNotValid())
                {
                    if (dragType == 0)
                    {
                        player.dropItem(inventoryplayer.getItemStack(), true);
                        inventoryplayer.setItemStack(ItemStack.EMPTY_ITEM_STACK);
                    }
            ...
            else if (clickTypeIn == ClickType.QUICK_MOVE)
            {
                ...
                for (ItemStack itemstack7 = this.transferStackInSlot(player, slotId); !itemstack7.isNotValid() && ItemStack.areItemsEqual(slot5.getStack(), itemstack7); itemstack7 = this.transferStackInSlot(player, slotId))
                {
            ...
            else
            {
                ...
                if (slot6 != null)
                {
                    ...
                    if (itemstack8.isNotValid())
                    {
                        if (!itemstack11.isNotValid() && slot6.isItemValid(itemstack11))
                        {
                            int i3 = dragType == 0 ? itemstack11.getStackSize() : 1;
                    ...
                    {
                        if (itemstack11.isNotValid())
                        {
                            if (itemstack8.isNotValid())
                            {
                                slot6.putStack(ItemStack.EMPTY_ITEM_STACK);
                                inventoryplayer.setItemStack(ItemStack.EMPTY_ITEM_STACK);
                            }
                            else
                            {
                                int l2 = dragType == 0 ? itemstack8.getStackSize() : (itemstack8.getStackSize() + 1) / 2;
                        ...
                        else if (slot6.isItemValid(itemstack11))
                        {
                            ...
                            {
                                int k2 = dragType == 0 ? itemstack11.getStackSize() : 1;

                                if (k2 > slot6.getItemStackLimit(itemstack11) - itemstack8.getStackSize())
                                {
                                    k2 = slot6.getItemStackLimit(itemstack11) - itemstack8.getStackSize();
                                }

                                if (k2 > itemstack11.getMaxStackSize() - itemstack8.getStackSize())
                                {
                                    k2 = itemstack11.getMaxStackSize() - itemstack8.getStackSize();
                                }

                                itemstack11.decreaseStackSize(k2);
                                itemstack8.increaseStackSize(k2);
                            }
                            else if (itemstack11.getStackSize() <= slot6.getItemStackLimit(itemstack11))
                            {
                                slot6.putStack(itemstack11);
                                inventoryplayer.setItemStack(itemstack8);
                            }
                        }
                        else if (itemstack8.getItem() == itemstack11.getItem() && itemstack11.getMaxStackSize() > 1 && (!itemstack8.getHasSubtypes() || itemstack8.getMetadata() == itemstack11.getMetadata()) && ItemStack.areItemStackTagsEqual(itemstack8, itemstack11) && !itemstack8.isNotValid())
                        {
                            int j2 = itemstack8.getStackSize();

                            if (j2 + itemstack11.getStackSize() <= itemstack11.getMaxStackSize())
                            {
                                itemstack11.increaseStackSize(j2);
        ...
        else if (clickTypeIn == ClickType.SWAP && dragType >= 0 && dragType < 9)
        {
            ...
            if (!itemstack6.isNotValid() || !itemstack10.isNotValid())
            {
                if (itemstack6.isNotValid())
                {
                    if (slot4.canTakeStack(player))
                    {
                        inventoryplayer.setInventorySlotContents(dragType, itemstack10);
                        slot4.func_190900_b(itemstack10.getStackSize());
                        slot4.putStack(ItemStack.EMPTY_ITEM_STACK);
                        slot4.func_190901_a(player, itemstack10);
                    }
                }
                else if (itemstack10.isNotValid())
                {
                    if (slot4.isItemValid(itemstack6))
                    {
                        int l1 = slot4.getItemStackLimit(itemstack6);

                        if (itemstack6.getStackSize() > l1)
                        {
                        ...
                        else
                        {
                            ...
                            inventoryplayer.setInventorySlotContents(dragType, ItemStack.EMPTY_ITEM_STACK);
                        }
                    }
                }
        ...
        else if (clickTypeIn == ClickType.CLONE && player.capabilities.isCreativeMode && inventoryplayer.getItemStack().isNotValid() && slotId >= 0)
        {
            ...
            if (slot3 != null && slot3.getHasStack())
            {
                ...
                itemstack5.setStackSize(itemstack5.getMaxStackSize());
                inventoryplayer.setItemStack(itemstack5);
            }
        }
        else if (clickTypeIn == ClickType.THROW && inventoryplayer.getItemStack().isNotValid() && slotId >= 0)
        {
            Slot slot2 = this.inventorySlots.get(slotId);

            if (slot2 != null && slot2.getHasStack() && slot2.canTakeStack(player))
            {
                ItemStack itemstack4 = slot2.decrStackSize(dragType == 0 ? 1 : slot2.getStack().getStackSize());
        ...
        else if (clickTypeIn == ClickType.PICKUP_ALL && slotId >= 0)
        {
            ...
            if (!itemstack1.isNotValid() && (slot == null || !slot.getHasStack() || !slot.canTakeStack(player)))
            {
                ...
                for (int k = 0; k < 2; ++k)
                {
                    for (int l = i; l >= 0 && l < this.inventorySlots.size() && itemstack1.getStackSize() < itemstack1.getMaxStackSize(); l += j)
                    {
                        ...
                        if (slot1.getHasStack() && canAddItemToSlot(slot1, itemstack1, true) && slot1.canTakeStack(player) && this.canMergeSlot(itemstack1, slot1))
                        {
                            ...
                            if (k != 0 || itemstack2.getStackSize() != itemstack2.getMaxStackSize())
                            {
                                int i1 = Math.min(itemstack1.getMaxStackSize() - itemstack1.getStackSize(), itemstack2.getStackSize());
                                ItemStack itemstack3 = slot1.decrStackSize(i1);
                                itemstack1.increaseStackSize(i1);

                                if (itemstack3.isNotValid())
                                {
                                    slot1.putStack(ItemStack.EMPTY_ITEM_STACK);
                                }
    ...
    public void func_192388_b(int p_192388_1_, ItemStack p_192388_2_)
    {
        ...
        else if (itemstack.getUnlocalizedName().equals(p_192388_2_.getUnlocalizedName()) && itemstack.getStackSize() < itemstack.getMaxStackSize())
        {
            itemstack.increaseStackSize(p_192388_2_.getStackSize());
        }
    }
    ...
    protected boolean mergeItemStack(ItemStack stack, int startIndex, int endIndex, boolean reverseDirection)
    {
        ...
        if (stack.isStackable())
        {
            while (!stack.isNotValid())
            {
                ...
                if (!itemstack.isNotValid() && itemstack.getItem() == stack.getItem() && (!stack.getHasSubtypes() || stack.getMetadata() == itemstack.getMetadata()) && ItemStack.areItemStackTagsEqual(stack, itemstack))
                {
                    int j = itemstack.getStackSize() + stack.getStackSize();

                    if (j <= stack.getMaxStackSize())
                    {
                        stack.setStackSize(0);
                        itemstack.setStackSize(j);
                        slot.onSlotChanged();
                        flag = true;
                    }
                    else if (itemstack.getStackSize() < stack.getMaxStackSize())
                    {
                        stack.decreaseStackSize(stack.getMaxStackSize() - itemstack.getStackSize());
                        itemstack.setStackSize(stack.getMaxStackSize());
                        slot.onSlotChanged();
                        flag = true;
                    }
                }
        ...
        if (!stack.isNotValid())
        {
            ...
            while (true)
            {
                ...
                if (itemstack1.isNotValid() && slot1.isItemValid(stack))
                {
                    if (stack.getStackSize() > slot1.getSlotStackLimit())
                    {
                        slot1.putStack(stack.splitStack(slot1.getSlotStackLimit()));
                    }
                    else
                    {
                        slot1.putStack(stack.splitStack(stack.getStackSize()));
                    }
    ...
    public static boolean canAddItemToSlot(@Nullable Slot slotIn, ItemStack stack, boolean stackSizeMatters)
    {
        ...
        {
            return slotIn.getStack().getStackSize() + (stackSizeMatters ? 0 : stack.getStackSize()) <= stack.getMaxStackSize();
        }
        else
        {
            return flag;
    ...
    public static void computeStackSize(Set<Slot> dragSlotsIn, int dragModeIn, ItemStack stack, int slotStackSize)
    {
        ...
        {
            case 0:
                stack.setStackSize(MathHelper.floor((float)stack.getStackSize() / (float)dragSlotsIn.size()));
                break;
            ...
            case 2:
                stack.setStackSize(stack.getItem().getItemStackLimit());
        }

        stack.increaseStackSize(slotStackSize);
    }
    ...
    public static int calcRedstoneFromInventory(@Nullable IInventory inv)
    {
        ...
        else
        {
            ...
            for (int j = 0; j < inv.getSizeInventory(); ++j)
            {
                ...
                if (!itemstack.isNotValid())
                {
                    f += (float)itemstack.getStackSize() / (float)Math.min(inv.getInventoryStackLimit(), itemstack.getMaxStackSize());
                    ++i;
                }
            }
