...
public class TileEntityFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    public void setInventorySlotContents(int index, ItemStack stack)
    {
        ...
        boolean flag = !stack.isNotValid() && stack.isItemEqual(itemstack) && ItemStack.areItemStackTagsEqual(stack, itemstack);
        this.furnaceItemStacks.set(index, stack);

        if (stack.getStackSize() > this.getInventoryStackLimit())
        {
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            if (this.isBurning() || !itemstack.isNotValid() && !((ItemStack)this.furnaceItemStacks.get(0)).isNotValid())
            {
                    ...
                    if (this.isBurning())
                    {
                        ...
                        if (!itemstack.isNotValid())
                        {
                            ...
                            if (itemstack.isNotValid())
                            {
                                ...
                                this.furnaceItemStacks.set(1, item1 == null ? ItemStack.EMPTY_ITEM_STACK : new ItemStack(item1));
                            }
                        }
                    }
                }
    ...
    {
        if (((ItemStack)this.furnaceItemStacks.get(0)).isNotValid())
        {
            return false;
        }
        else
        {
            ...
            else
            {
                ...
                else if (itemstack1.getStackSize() < this.getInventoryStackLimit() && itemstack1.getStackSize() < itemstack1.getMaxStackSize())
                {
                    return true;
                }
                else
                {
                    return itemstack1.getStackSize() < itemstack.getMaxStackSize();
                }
            }
        }
    }
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            if (itemstack.getItem() == Item.getItemFromBlock(Blocks.SPONGE) && itemstack.getMetadata() == 1 && !((ItemStack)this.furnaceItemStacks.get(1)).isNotValid() && ((ItemStack)this.furnaceItemStacks.get(1)).getItem() == Items.BUCKET)
            {
