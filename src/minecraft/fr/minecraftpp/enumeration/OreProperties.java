...
{
	EMPTY("EMPTY", OreProperties.UNDEFINED_TIER, 0), 
	BLUEDYE("bluedye", OreProperties.UNDEFINED_TIER, 0), 
	CURRENCY("currency", OreProperties.UNDEFINED_TIER, 5), 
	BEACON("beacon", OreProperties.UNDEFINED_TIER, 2), 
	FUEL("fuel", OreProperties.UNDEFINED_TIER, 1),
	MATERIAL("material", OreProperties.UNDEFINED_TIER, 1), 
