...
public class RecipeHoe extends RecipeEquipment
{
	...
	{
		return new Blueprint(new Item[][] { { this.material, this.material }, { Items.getItem(Items.AIR), Items.getItem(Items.STICK) }, { Items.getItem(Items.AIR), Items.getItem(Items.STICK) } });
	}
}
