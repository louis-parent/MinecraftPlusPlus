...
public class RecipeLeggings extends RecipeEquipment
{
	...
	{
		return new Blueprint(new Item[][] {{this.material, this.material, this.material}, {this.material, Items.EMPTY_ITEM, this.material}, {this.material, Items.EMPTY_ITEM, this.material}});
	}
